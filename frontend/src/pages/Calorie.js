...
const Calorie = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const token = localStorage.getItem("token");
      if (!token) {
        setError("Please log-in to calculate your calorie requirements.");
        return;
      }
    ...
    <div className="container">
      ...
      <div className="main-content-container">
        <aside className="sidebar2">
          <h2><u>Wellness Tips</u></h2> <br/>
          <h3>Weight Loss →</h3> <br/>
          <p>To lose weight you need to eat in a calorie deficit, meaning that you will have to consume lesser calories than your maintainence calories (your daily calorie need)</p> <br/>
          <h3>Weight Gain →</h3> <br/>
